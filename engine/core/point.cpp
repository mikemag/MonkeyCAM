...
Point Point::MinPoint{MCFixed::fromPreScaled(LLONG_MIN),
                      MCFixed::fromPreScaled(LLONG_MIN),
                      MCFixed::fromPreScaled(LLONG_MIN)};

Point Point::MaxPoint{MCFixed::fromPreScaled(LLONG_MAX),
...
double Point::distance(Point p) const { return sqrt(distance2(p)); }
